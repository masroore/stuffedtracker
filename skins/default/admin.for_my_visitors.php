...
<?for ($i=0;$i<count($VisitorsList);$i++) {
	...
	<td width=100%>
	<B style="color:#000000"><a href="<?php echo getURL('visitor', 'CpId=' . $Row->COMPANY_ID . '&ViewId=' . $Row->ID)?>"><?php echo $Row->NAME?></a></B>
	<?if ($Row->DESCRIPTION) {?>
...
<input type=submit value="<?php echo $Lang['AddChoosedToMy1']?>">
</td></tr>
<?}?>
</form>
