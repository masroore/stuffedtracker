...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" onload="<?php echo $AdditionalOnload?>">
...
<p><a href="<?php echo getURL('default', '', 'admin')?>"><?if (!$nsProduct->WHITE || !$nsProduct->WHITE_NO_LOGO) {?><img src="<?php echo FileLink('images/logo_01.gif'); ?>" width="177" height="62" border="0"><?}?>
<?if ($nsProduct->WHITE&&$nsProduct->WHITE_NO_LOGO&&$nsProduct->WHITE_LOGO) {?><IMG SRC="<?php echo $nsProduct->WHITE_LOGO?>" BORDER="0" ALT=""><?}?></a></p>
</td>
...
<br><span  class=HeaderMenu><?php echo $Lang['CurVer'] . $nsProduct->VERSION?>
 | <a href="<?php echo getURL('default', '', 'admin')?>"><?php echo $Lang['BackToHome']?></a>
</span>
...
<span style="font-family:Arial;color:#777777;font-size:16px;"><?php echo $SubTitle?></span>
</td></tr>
