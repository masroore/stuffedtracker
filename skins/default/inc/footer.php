...
<td bgcolor="<?php echo ((!$nsProduct->WHITE || !$nsProduct->WHITE_NO_COPY) ? '#707070' : '')?>" height=1>
<p><img src="<?php echo FileLink('images/0.gif'); ?>" width="1" height="1" border="0"></p>
</td>
</tr>
<tr>
...
<?php echo str_replace('{VERSION}', ValidVar($nsProduct->VERSION), ValidVar($Lang['Powered']))?>
<?}?>
</p>
</td>
</tr>
