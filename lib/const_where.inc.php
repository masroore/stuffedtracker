...
for ($i = 0; $i < count($WhereArr); ++$i) {
    ...
    if ($WhereArr[$i]['Mode'] == 'SourceGrp') {
        ...
        if (ValidId($WhereArr[$i]['Id'])) {
            if ($WhereArr[$i]['Id'] > 0) {
                ...
                $WhereArr[$i]['Name2'] = $Lang['OtherSource'];
            }
            $MetaTitle .= ': ' . $WhereArr[$i]['Name2'];
    ...
    if ($WhereArr[$i]['Mode'] == 'Vis') {
        ...
        if (ValidId($WhereArr[$i]['Id'])) {
            ...
            if ($VisitorName) {
                $WhereArr[$i]['Name2'] = htmlspecialchars(stripslashes($VisitorName));
            }
            $MetaTitle .= ': ' . $WhereArr[$i]['Name2'];
    ...
    if ($WhereArr[$i]['Mode'] == 'AgentGrp') {
        ...
        if (ValidId($WhereArr[$i]['Id'])) {
            if ($WhereArr[$i]['Id'] > 0) {
                ...
                $WhereArr[$i]['Name2'] = $Lang['OtherAgentGrp'];
            }
            $MetaTitle .= ': ' . $WhereArr[$i]['Name2'];
    ...
    if ($WhereArr[$i]['Mode'] == 'Order') {
        ...
        if (ValidId($WhereArr[$i]['Id'])) {
            ...
            $WhereArr[$i]['Name2'] .= ($CustomOID) ?: $WhereArr[$i]['Id'];
            $MetaTitle .= ': ' . $WhereArr[$i]['Name2'];
