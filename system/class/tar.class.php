...
// +----------------------------------------------------------------------+
//
// $Id: tar.class.php,v 1.3 2005/07/04 09:37:07 shalmoo Exp $
...
class Archive_Tar extends PEAR
{
    ...
    // {{{ destructor
    public function _Archive_Tar(): void
    {
        $this->_close();
    ...
    // {{{ _error()
    public function _error($p_message): void
    {
        // ----- To be completed
    ...
    // {{{ _warning()
    public function _warning($p_message): void
    {
        // ----- To be completed
        $this->raiseError($p_message);
    }
    ...
    public function _openAppend()
    {
        ...
        if ($this->_compress) {
            ...
            if ($this->_compress_type == 'gz') {
                ...
                // ----- Read the following blocks but not the last one
                while (($v_buffered_lines[] = @bzread($v_temp_tar, 512)) !== '') {
